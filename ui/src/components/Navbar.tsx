...
function Navbar() {
    return (
      <nav className="navbar navbar-expand-lg pt-3 shadow">
        <NavLink to="/" className="navbar-brand ps-5 pe-4">
          <img
        ...
        <div className="collapse navbar-collapse ms-3" id="navbarNavDropdown">
          <ul className="navbar-nav justify-content-evenly">
            <li className="nav-item ms-5 me-5 pe-3 text-center">
              <NavLink to="/do" className="nav-link">
                THINGS TO
                <br /> DO
              </NavLink>
            </li>
            <li className="nav-item ms-5 me-5 pe-3 text-center">
              <NavLink to="/stay" className="nav-link">
                PLACES <br />
                TO STAY
              </NavLink>
            </li>
            <li className="nav-item  ms-5 me-5 pe-3 text-center">
              <NavLink to="/dine" className="nav-link">
                RESTAURANTS & <br /> NIGHTLIFE
              </NavLink>
            </li>
            <li className="nav-item  ms-5 me-5  pe-3 text-center">
