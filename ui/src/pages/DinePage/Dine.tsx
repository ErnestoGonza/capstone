...
function Dine () {
    ...
    return (
      <div>
        <PageHero
          imageSrc="https://ernestocapstoneimages.blob.core.windows.net/images/dine-hero.jpg"
          altText="Couple enjoying private dining at lookout spot on island"
        />
        <div className="container">
          <PageIntro
            heading="restaurants & nightlife"
            introText="One of the best ways to deepen your knowledge of Taniti culture is to get
      ...
      pace for those looking to go out and show off their dance moves."
          ...
          <form className="row ps-5 mt-5">
            <Dropdown
              apiEndpoint="/api/restaurants-and-nightlife/type"
              label="By Type"
              id="dineType"
              onChange={(newDineType) => setDineType(newDineType)}
            />
            <Dropdown
              apiEndpoint="/api/restaurants-and-nightlife/region"
              label="Region"
              id="region"
